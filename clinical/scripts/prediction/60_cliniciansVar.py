...
ssh skatz@212.235.237.86 -p 62636 'source miniconda3/bin/activate sklearn | /home/skatz/miniconda3/envs/sklearn/bin/python /home/skatz/PROJECTS/covid/disease_severity/discoveryValidation/clinical/scripts/prediction/60_cliniciansVar.py'
'''
...
PATH_base = "/home/skatz/PROJECTS/covid/disease_severity/discoveryValidation/clinical"
...
#### Feature selection:
varFolder = "clinicians"
vars = "clinicians_vars"   
varPath = f"{PATH_base}/results/featureSelection/{varFolder}/{vars}.txt"

''' 
Define paths
'''
resultsPath = f"{PATH_base}/results/prediction/featureSelection/{varFolder}/{vars}/modelComparison/zigaPipeline"
...
for model in models.keys():
      ...
      clf = GridSearchCV(models[model], grids[model], scoring='balanced_accuracy', verbose=1, cv=3, n_jobs=-1)  ##cv=5
